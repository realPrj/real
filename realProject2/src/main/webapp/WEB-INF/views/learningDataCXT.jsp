					...
					<div id="content"
						...
						<div class="input-group input-group-md" role="group"
							...
							<table border="2" width="700px" height="300px";  >
								...
								<tr>
										<td colspan="2"><input type="button" name="delete" value="삭제" class="btn"
											onClick="deleteData('${theme }','${date }','${roomcode}','${writeId }')">
								
										<input type="button" name="update" value="수정" class="btn"
											onClick="dataUpdate('${theme }','${date }','${roomcode}','${writeId }','${content }')">
									</tr>
							</table>
						</div>
