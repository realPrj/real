...
<input type="hidden" name="identity" value="${identity }" />
	...
	<div>
		 ...
		 아이디 &nbsp;&nbsp; <input type="text" name="id" class="box" placeholder="" ><br/>
		 <br/>
		 이메일 &nbsp;&nbsp; <input type="text" name="email" class="box" placeholder=""><br/>
		 <br/>
		 
		 <div id= "sub" style="padding-left:50px;">
			 <a onClick="eventClick('idFindPageform','idFindPage','post')">아이디 찾기</a>
		...
		<br/>
		<br/>
		<input type="button" value="비밀번호 찾기" class="btn" onClick="findPwd('id','email')"/>
