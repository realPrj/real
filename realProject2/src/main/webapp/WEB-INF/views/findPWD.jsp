...
<input type="hidden" name="identity" value="${identity }" />
  ...
  비밀번호 찾기
        ...
        <input type="button" value="비밀번호 찾기" class="btn"  onClick="findPwd()"/>
		<input type="button" value="메인으로" style="width:100pt;height:30pt;" class="btn" size="10px" onClick="eventClick('homeform','home','post')"/>
		<input type="button" value="아이디 찾기" style="width:100pt;height:30pt;" class="btn" onClick="eventClick('idFindPageform','idFindPage','post')"/>
</div>
