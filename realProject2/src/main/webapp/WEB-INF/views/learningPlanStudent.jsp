...
function continuing(yearcode){
	...
	function planCXT(value) {
		...
		createForm1("learningPlanCTXStudentPageform", "learningPlanCTXStudent", "POP");

		var form = document.getElementsByName("learningPlanCTXStudentPageform")[0];

		window.open('', 'POP',
				"width=500px, height=500px, resizable = no, scrollbars = no");
