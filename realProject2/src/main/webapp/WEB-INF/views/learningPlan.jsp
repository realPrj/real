	...
	$.ajax({
        ...
        success : function(data) {  
        	...
        	for(var i =0; i < data[0].allSize; i++){
        		...
        		html += "<tbody align=center>";
        		html += "<tr>";
        		html += "<td><input type='button' onClick=planCXT('"+data[0].month+data[i].Sunday+"') name='day"+data[0].month+data[i].Sunday+"' style='color:#FF0000;background: "+Sunday+";' class='btn' value='"+data[i].Sunday+"' /></br></td>";
        		html += "<td><input type='button' onClick=planCXT('"+data[0].month+data[i].Monday+"') name='day"+data[0].month+data[i].Monday+"' class='btn' style='color:#000000;background: "+Monday+";' value='"+data[i].Monday+"' /></br></td>";
        		html += "<td><input type='button' onClick=planCXT('"+data[0].month+data[i].Tuesday+"') name='day"+data[0].month+data[i].Tuesday+"' class='btn' style='color:#000000;background: "+Tuesday+";' value='"+data[i].Tuesday+"' /></br></td>";
        		html += "<td><input type='button' onClick=planCXT('"+data[0].month+data[i].Wednesday+"') name='day"+data[0].month+data[i].Wednesday+"' class='btn' style='color:#000000;background: "+Wednesday+";' value='"+data[i].Wednesday+"' /></br></td>";
        		html += "<td><input type='button' onClick=planCXT('"+data[0].month+data[i].Thursday+"') name='day"+data[0].month+data[i].Thursday+"' class='btn' style='color:#000000;background: "+Thursday+";' value='"+data[i].Thursday+"' /></br></td>";
        		html += "<td><input type='button' onClick=planCXT('"+data[0].month+data[i].Friday+"') name='day"+data[0].month+data[i].Friday+"' class='btn' style='color:#000000;background: "+Friday+";' value='"+data[i].Friday+"' /></br></td>";
        		html += "<td><input type='button' onClick=planCXT('"+data[0].month+data[i].Saturday+"') name='day"+data[0].month+data[i].Saturday+"' style='color:#0100FF;background: "+Saturday+";' class='btn' value='"+data[i].Saturday+"' /></br></td>";
        		html += "</tr>";
        		html += "</tbody>";
		...
		<div class="sidebar" data-background-color="white"
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li></li>
					<li><a onClick="menu('12')"> <i class="ti-pencil-alt " style="color:#C90000"></i>
							<p style="color:#C90000">강의계획서</p>
					</a></li>
